    ...
    catalog.forEach((item) => {
      ...
      card.innerHTML = `
        <div class="thumb" style="position:relative">
            <img src="${imgPath}" alt="${item.name}" onerror="this.src='img/coffeelogo.png'" />
            ${isOutOfStock ? '<div style="position:absolute; inset:0; background:rgba(255,255,255,0.7); display:grid; place-items:center; color:red; font-weight:bold; font-size:1.5rem;">OUT OF STOCK</div>' : ''}
        </div>
