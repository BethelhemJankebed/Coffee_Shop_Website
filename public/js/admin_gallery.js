...
<<<<<<< HEAD:frontend/js/admin_gallery.js
...
function loadGalleryItems() {
    fetch("api.php?controller=gallery&action=list")
        .then(res => res.json())
        .then(data => {
...
>>>>>>> 78af4aa (Refactored project to use complete MVC Architecture and OOP PHP):public/js/admin_gallery.js
}
...
=======
    fetch(`api.php?controller=gallery&action=delete`, {
>>>>>>> 78af4aa (Refactored project to use complete MVC Architecture and OOP PHP):public/js/admin_gallery.js
        method: "POST",
