...
const admin = {
  ...
  // Stats
  async loadStats() {
    const data = await this.fetchData('api.php?controller=orders&action=list');
    if (data && data.orders) {
      const now = new Date();
  ...
  // Products
  async loadProducts() {
    const data = await this.fetchData('api.php?controller=products&action=list');
  ...
  async deleteProduct(id) {
    if (confirm('Delete this product?')) {
      const res = await this.postData('api.php?controller=products&action=delete', { id });
  ...
  // Users
  async loadUsers() {
    const data = await this.fetchData('api.php?controller=users&action=list');
  ...
  async deleteUser(id) {
    if (confirm('Delete this user?')) {
      const res = await this.postData('api.php?controller=users&action=delete', { id });
  ...
  async deleteOrder(id) {
    if (confirm('Delete this order?')) {
      const res = await this.postData('api.php?controller=orders&action=delete', { id });
  ...
  async deleteReview(id) {
    if (confirm('Purge this review?')) {
      const res = await this.postData('api.php?controller=reviews&action=delete', { id });
  ...
  // Gallery
  async loadGallery() {
    const data = await this.fetchData('api.php?controller=gallery&action=list');
  ...
  async deleteGallery(id) {
    if (confirm('Remove this gallery item?')) {
      const res = await this.postData('api.php?controller=gallery&action=delete', { id });
